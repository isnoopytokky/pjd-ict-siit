...
<div id="registration-form">
	<div class='fieldset'>     
		<form action="connection/do-login.php" method="post" data-validate="parsley">
			<div class='row'>
				<label for='txt_username'>User Name</label>
				<input type="text" placeholder="User Name" name='txt_username' id='txt_username' data-required="true" data-error-message="Your User Name is required">
			</div>
			<div class='row'>
