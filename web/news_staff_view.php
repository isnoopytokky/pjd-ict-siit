	...
	<div id="contents_news">
		<div class="news_staff"> 	
				...
				<div class="row">
					  ...
					  <div class="panel-heading">News Lists</div>
					  <!-- Table -->
					  <div class="panel-body" style="color:#000;">
							...
							<div class="col-md-2">
					    		...
					    		<a href="news_view.php"><button class="btn-xs btn-warning">Edit</button></a>
					    		<a href="news_view.php"><button class="btn-xs btn-danger">Delete</button></a>	
				    		</div>
				    		</div>
				    		<?php  }?>
					  </div>					  
